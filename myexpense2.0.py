...
#Amount Totals
print('This is the mean of the account transaction history:',df['Amount'].mean()) 
print('This is the largest widtrawal:', df['Amount'].min) 
